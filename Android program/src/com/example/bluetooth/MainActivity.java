...
public class MainActivity extends Activity {
  ...
  Button btnForward, btnBack, btnStop, btnLeft, btnRight, btnExit;
  TextView txtArduino;
  Handler h;
  ...
  private static String address = "00:12:06:12:80:22";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    btnForward = (Button) findViewById(R.id.btnForward);					// кнопка включения
    btnBack = (Button) findViewById(R.id.btnBack);				// кнопка выключения
